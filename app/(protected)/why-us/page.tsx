    ...
    return (
        <div className="space-y-6">
            <section className="container mx-auto py-20">
                ...
                <p className="text-center mt-4 pt-5">
                    <a href="/" className="inline-flex items-center px-4 py-2 bg-blue-500 text-white font-bold rounded-md hover:bg-blue-700">Join Compile & Hire Today!</a>
                </p>
                </section>
        </div>
    );
